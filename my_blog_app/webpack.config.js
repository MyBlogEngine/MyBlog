...
module.exports = {
    ...
    output: { // Up next is the output location for our built bundle.
        path: path.join(__dirname, 'dist'),
        filename: path.join('build', 'app.js')
    },
    resolve: {
        extensions: ['.ts', '.tsx', '.js'] // Next we tell Webpack to support .ts and .tsx file extensions along with the original .js extension.
    },
    module: {
        rules: [
